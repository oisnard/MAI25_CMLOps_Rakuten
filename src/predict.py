...
def load_dataset() -> tuple:
    ...
    if 'feature' not in X_test.columns:
        logger.error("The 'feature' column is missing in the X_test dataset.")
    ...
    if 'prdtypecode' not in y_test.columns:
        logger.error("The 'prdtypecode' column is missing in the y_test dataset.")
    ...
    if not pd.api.types.is_integer_dtype(y_test['prdtypecode']):
        logger.error("The 'prdtypecode' column must be of integer type.")
    ...
    if not pd.api.types.is_string_dtype(X_test['feature']):
        logger.error("The 'feature' column must be of string type.")
